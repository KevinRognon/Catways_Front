...
export default function LoginForm() {
    return (
        <>
            <form className="flex flex-col justify-center gap-2 " action="https://catways.onrender.com/authenticate" method="post">
                <input className="border-lime-300 border-2 p-2 outline-lime-800" type="text" name="username" id="username" required placeholder="Username"/>
