...
function Account() {
    ...
    return (
        <>
            {
                showModal && <ModalUploadFile onClick={switchModal} title="Upload" text="Test" />
            }
            <div className="grid lg:grid-cols-3 gap-20 lg:place-items-center">

                    <div className="flex flex-col gap-5 items-center justify-start">
                        <div className="relative bg-gray-700 p-10 rounded-full hover:cursor-pointer">
                            <svg onClick={switchModal} className="absolute bottom-0 right-0" xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 48 48"><circle cx="24" cy="24" r="21" fill="#4CAF50"/><g fill="#fff"><path d="M21 14h6v20h-6z"/><path d="M14 21h20v6H14z"/></g></svg>
